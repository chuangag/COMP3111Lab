namespace SinExWebApp20309206.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class SinExConfiguration : DbMigrationsConfiguration<SinExWebApp20309206.Models.SinExDatabaseContext>
    {
        ...
        protected override void Seed(SinExWebApp20309206.Models.SinExDatabaseContext context)
        {
            ...
            context.PackageTypeSizes.AddOrUpdate(
                ...
                new PackageTypeSize { PackageTypeSizeID = 1, PackageTypeID = 1, Size = "(Size: 250x350mm; Weight limit: Not Applicable)" },
                new PackageTypeSize { PackageTypeSizeID = 2, PackageTypeID = 2, Size = "(Size: small - 350x4000mm; Weight limit: 5kg)" },
                new PackageTypeSize { PackageTypeSizeID = 3, PackageTypeID = 2, Size = "(Size: large - 450x550mm; Weight limit: 5kg)" },
                new PackageTypeSize { PackageTypeSizeID = 4, PackageTypeID = 3, Size = "(Size: 1000x80mm; Weight limit: Not Applicable)" },
                new PackageTypeSize { PackageTypeSizeID = 5, PackageTypeID = 4, Size = "(Size: small - 300x250x150mm; Weight limit: 10kg)" },
                new PackageTypeSize { PackageTypeSizeID = 6, PackageTypeID = 4, Size = "(Size: medium - 400x350x250mm; Weight limit: 20kg)" },
                new PackageTypeSize { PackageTypeSizeID = 7, PackageTypeID = 4, Size = "(Size: large - 500x450x350mm; Weight limit: 30kg)" }
                );
            ...
            context.Currencies.AddOrUpdate(
                p => p.CurrencyCode,
             new Currency { CurrencyCode="CNY", ExchangeRate=1 },
